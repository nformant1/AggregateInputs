...
if __name__ == '__main__':
    ...
    # aggregate 5 (txcount) inputs into one output, sent to nformntrCCWRSRApRFJDQs2YcrMEoy49CL (aggAddress)
    txcount = 5
    aggAddress = "nformntrCCWRSRApRFJDQs2YcrMEoy49CL"
